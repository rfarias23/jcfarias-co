...
iCloud Desktop sync y `node_modules` está evacuado a la nube como archivos *dataless*
...
También están *dataless* `public/images/*` (las tres imágenes) y los briefs de `.superpowers/`.
...
| Solo Newsreader 300 / Instrument Sans 400-500 renderizados | **CUMPLE en render** | `h1`: Newsreader `font-weight:300`; `body`: Instrument Sans `400`. Ver §4-D3 sobre lo que se *embebe*. |

...
4. *(solo si B9 aprobado)* DADO `package.json` tras el upgrade, CUANDO se ejecuta `npm ls next` y `npm ci`, ENTONCES `next` es una versión 15.5.x ≥ la parcheada y la salida de `npm ci` no contiene `CVE-2025-66478`.
